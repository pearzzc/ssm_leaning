    ...
    <div class="login_center">
        ...
        <div class="login_bg">
            ...
            <form action="/mystore2/LoginServlet"  id="login" method="post">
                <!--用户名-->
               <div class="username"><span></span><input id="name" type="text" name="name"></div>
                <!--密码-->
                <div class="password"><span></span><input id="password" type="text" name="password"></div>
                <div class="login_btn"> <input type="button" class="login_btn" value="登录"  onclick="check()"> </div>
            </form>
