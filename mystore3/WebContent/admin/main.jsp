...
<c:forEach items="${requestScope.allGoods }" var="goods" varStatus="status">
	<ul class="list_goods_ul">
        ...
        <li>${goods.g_name }</li>
        <li>${goods.g_price }</li>
        <li><a href="${pageContext.request.contextPath }/GoodsEditUIServlet?id=${goods.g_id}"><img class="img_icon" src="${pageContext.request.contextPath }/admin/images/edit_icon.png" alt=""></a></li>
        <li><a href="${pageContext.request.contextPath }/GoodsDelServlet?id=${goods.g_id}"><img class="img_icon" src="${pageContext.request.contextPath }/admin/images/delete_icon.png" alt=""></a></li>
    </ul>
</c:forEach>
...
<script>
    ...
    $("#add").click(function () {
        ...
        $(window).attr('location','${ pageContext.request.contextPath}/GoodsAddUIServlet');
    });
