...
<div class="main_top">
    ...
    <div class="edit_content">
		<form action="${ctx }/GoodsServlet?action=addGoods" method="post" accept-charset="UTF-8" id="add_form" style="background: none; width: 700px;">
			<div class="item1">
            <div>
                <span>商品名称：</span>
                <input type="text" class="am-form-field" name="g_name">&nbsp;&nbsp;
            </div>
            <div>
                <span>商品价格：</span>
                <input type="text" class="am-form-field" name="g_price">
            </div>
        ...
        <div class="item1">
        	...
        	<div>
        		<span>是否热门：</span>
                 <select id="category_select" name="g_is_hot">
        ...
        <div class="item1 item_desc">
            <span>商品描述：</span>
         <textarea  id="desc_goods" name="g_desc" rows="4" cols="50"></textarea>
        </div>
